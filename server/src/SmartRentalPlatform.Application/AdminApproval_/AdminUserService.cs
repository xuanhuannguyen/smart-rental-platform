...
public class AdminUserService : IAdminUserService
{
        ...
        CancellationToken cancellationToken = default)
    {
        var query = _context.Users
            ...
            .Where(x => !x.UserRoles.Any(ur => ur.Role.Name == SmartRentalPlatform.Domain.Enums.RoleName.Admin));
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (user.OnboardingStatus == Domain.Enums.OnboardingStatus.Completed)
        {
            var approvedKyc = user.KycVerifications
                .Where(x => x.Status == Domain.Enums.KycVerificationStatus.Approved)
