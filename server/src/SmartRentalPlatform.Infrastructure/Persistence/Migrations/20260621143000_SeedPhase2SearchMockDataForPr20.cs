...
namespace SmartRentalPlatform.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260621143000_SeedPhase2SearchMockDataForPr20")]
    public partial class SeedPhase2SearchMockDataForPr20 : Migration
    {
                ...
                BEGIN
                    ...
                    FOR city_index IN 1..3 LOOP
                        ...
                        FOR i IN 1..80 LOOP
                            ...
                            uuid_from_text := md5('phase2-rental-policy-' || house_number);
                            policy_id := (
                                substr(uuid_from_text, 1, 8) || '-' ||
                                substr(uuid_from_text, 9, 4) || '-' ||
                                substr(uuid_from_text, 13, 4) || '-' ||
                    ...
                    WHERE h.landlord_user_id = phase2_landlord_id
