...
namespace SmartRentalPlatform.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260622113000_SeedKfcScenarioDataset")]
    public partial class SeedKfcScenarioDataset : Migration
    {
        public const string DefaultPassword = "Demo@123456";

        public const string AdminEmail = "admin.hoasen@example.com";
        public const string LandlordEmail = "nguyen.xuan.huan@example.com";
        public const string MainTenantEmail = "le.quang.linh@example.com";
        ...
        private static readonly Guid Landlord = Id("KFC-SCENARIO-LANDLORD-NGUYEN-XUAN-HUAN");
        private static readonly Guid MainTenant = Id("KFC-SCENARIO-TENANT-LE-QUANG-LINH");
        ...
        {
            migrationBuilder.Sql("DELETE FROM payment_webhook_logs WHERE provider_event_id LIKE 'KFC-SCENARIO-%' OR idempotency_key LIKE 'kfc-scenario:%';");
            migrationBuilder.Sql("DELETE FROM payment_transactions WHERE idempotency_key LIKE 'kfc-scenario:%' OR provider_order_code LIKE 'KFC-SCENARIO-%';");
            DeleteByIds(migrationBuilder, "wallet_transactions", "wallet_account_id", WalletAdmin, WalletLandlord, WalletMainTenant, WalletCoTenant, WalletNoKycTenant);
            DeleteByIds(migrationBuilder, "wallet_accounts", "id", WalletAdmin, WalletLandlord, WalletMainTenant, WalletCoTenant, WalletNoKycTenant);
            ...
            DeleteByIds(migrationBuilder, "kyc_verifications", "user_id", Landlord, MainTenant, CoTenant);
            DeleteByIds(migrationBuilder, "user_roles", "user_id", AdminUser, Landlord, MainTenant, CoTenant, NoKycTenant);
            DeleteByIds(migrationBuilder, "user_profiles", "user_id", AdminUser, Landlord, MainTenant, CoTenant, NoKycTenant);
            DeleteByIds(migrationBuilder, "users", "id", AdminUser, Landlord, MainTenant, CoTenant, NoKycTenant);
        }
