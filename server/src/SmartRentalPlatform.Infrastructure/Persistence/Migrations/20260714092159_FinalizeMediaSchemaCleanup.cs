...
namespace SmartRentalPlatform.Infrastructure.Persistence.Migrations
{
    ...
    public partial class FinalizeMediaSchemaCleanup : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // Backfill any remaining legacy contract files, including appendix PDFs, before dropping the old columns.
            migrationBuilder.Sql(
                """
                ...
                SELECT
                    ...
                    NULL,
                    CASE
                        WHEN cf.appendix_id IS NULL THEN 'ContractPdf'
                        ELSE 'ContractAppendixPdf'
                    END,
                    'Private',
                    'Linked',
                    'ContractFile',
                ...
                WHERE cf.media_asset_id IS NULL
            ...
            migrationBuilder.Sql(
                ...
                WHERE cf.media_asset_id IS NULL
                  AND cf.storage_object_key IS NOT NULL
                  AND cf.storage_object_key <> ''
                  AND ma.object_key = cf.storage_object_key;
                """);

            migrationBuilder.Sql(
                """
                UPDATE media_assets AS ma
                SET linked_entity_type = 'ContractFile',
                    linked_entity_id = cf.id,
                    scope = CASE
                        WHEN cf.appendix_id IS NULL THEN 'ContractPdf'
                        ELSE 'ContractAppendixPdf'
                    END,
